...
func (r *RoleRepositoryImp) GetRoleById(id int64) (*models.Role, error) {
...
func (r *RoleRepositoryImp) GetRoleByName(name string) (*models.Role, error) {
...
func (r *RoleRepositoryImp) GetAllRoles() ([]*models.Role, error) {
...
func (r *RoleRepositoryImp) CreateRole(name string, description string) (*models.Role, error) {
...
func (r *RoleRepositoryImp) DeleteRoleById(id int64) error {
...
func (r *RoleRepositoryImp) UpdateRole(id int64, name string, description string) (*models.Role, error) {
